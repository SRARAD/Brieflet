...
public class ErrorCaptureMetaInfo {
   ...
   public static void init(Context context) 
   {
      ...
      try {
         ...
         extra+="No Package found to gather ErrorCaptureMetaInfo";
   }
   }
   ...
   public static String getErrorCaptureVersion() {
      return "0.2";
      // TODO replace a thing like below - was only showing 0.0 on initial tests
      //return ErrorCaptureMetaInfo.class.getPackage().getImplementationVersion();
   }
}
